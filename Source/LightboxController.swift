...
public protocol LightboxControllerImageDeleteDelegate: class {
    func lightboxController(_ controller: LightboxController, didDeleteAt index: Int)
}
...
open class LightboxController: UIViewController {
    ...
    open weak var imageDeleteDelegate: LightboxControllerImageDeleteDelegate?
...
extension LightboxController: HeaderViewDelegate {
    ...
    func headerView(_ headerView: HeaderView, didPressDeleteButton deleteButton: UIButton) {
        ...
        DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.5) {
            ...
            self.imageDeleteDelegate?.lightboxController(self, didDeleteAt: prevIndex)
        }
    }
